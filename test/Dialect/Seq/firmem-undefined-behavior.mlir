...
//CHECK-LABEL: hw.module @WriteConflict_OOB
  ...
  // CHECK-NEXT: [[TMP2:%.+]] = comb.parity [[TMP1]] : i1
  // CHECK-NEXT: [[NEWENABLE:%.+]] = comb.and [[TMP2]], [[ENABLE]] : i1
...
//------
  ...
  // CHECK-NEXT: [[WRITE:%.+]] = seq.firmem.read_write_port %mem[[[ADDR]]] = %data if [[MODE]], clock %clock enable [[ENABLE]] : <12 x 20>
...
// TODO: READ WRITE AS A READ OUT OF BOUNDS ENABLED/DISABLED